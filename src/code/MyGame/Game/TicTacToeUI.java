 ...
 * @version 1
 */
public final class TicTacToeUI extends TicTacToe
{
    ...
    private static final List<String>       SYMBOLS     = Arrays.asList(TUI.bold(" O "),
                                                                        TUI.bold(" X "));
    private static final Color.Background[] BACKGROUNDS = {Color.Background.GREEN,
     ...
     */
    public TicTacToeUI(final String... playerIDs)
    {
        super(playerIDs);
